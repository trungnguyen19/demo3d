...
class Renderer implements GLEventListener {
	...
	private boolean loadGLTextures(GLAutoDrawable gldrawable) {// GLDrawable
																// gldrawable) {
																// old
		GL gl = gldrawable.getGL();

		String resourceName = "nehe/lesson11/data/tim.png";
...
//		try {
//			texture = TextureReader.readTexture("nehe/lesson11/data/tim.png");
//		} catch (IOException e) {
//			return false;
//		}

		// Create Nearest Filtered Texture
		// gl.glGenTextures(1, textures); old
...
//				texture.getPixels());
	...
	public void init(GLAutoDrawable glDrawable) {// GLDrawable glDrawable) { old
