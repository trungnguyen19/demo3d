 ...
 * 
 * 'g': switch to the next fog mode 'l': toggle light on/off 'f': switch to the
 * next texture filters (nearest, linear, mipmap) Page-up/Page-down: zoom in/out
 * decrease/increase z up-arrow/down-arrow: decrease/increase x rotational speed
...
public class JOGL2Nehe15Fog implements GLEventListener, KeyListener {
	private static String TITLE = "Nehe #16: Cool Looking Fog"; // window's
																// title
	...
	private static float rotateAngleX = 0; // rotational angle for x-axis in
											// degree
	private static float rotateAngleY = 0; // rotational angle for y-axis in
											// degree
	...
	public void init(GLAutoDrawable drawable) {
		...
		gl.glClearColor(0.5f, 0.5f, 0.5f, 1.0f); // clear to the color of the
													// fog
