...
public class JOGL2Nehe18Quadrics implements GLEventListener, KeyListener {
	...
	public void init(GLAutoDrawable drawable) {
		...
		try {
			...
			// gl.glTexImage2D(GL.GL_TEXTURE_2D, 0, 3, textures[0].getWidth(),
			// textures[0]
	...
	public void display(GLAutoDrawable drawable) {
		...
		case 1: // cylinder
			...
			// The first parameter (1.0f) is the radius of the cylinder at base
			// (bottom).
			// The second parameter (1.0f) is the radius of the cylinder at the
			// top.
			// The third parameter ( 3.0f) is the height of the cylinder (how
			// long it is).
			// The fourth parameter (32) is how many subdivisions there are
			// "around" the Z axis,
			// and finally, the fifth parameter (32) is the amount of
		...
		case 2: // CD shaped disc
			...
			// This value can be zero, meaning there will be no hole in the
			// middle.
			// The larger the inner radius is, the bigger the hole in the middle
			// of the disc will be.
			...
			// If you make this value a lot larger than the inner radius you
			// will
			// end up with a thick ring.
			// The third parameter (32) is the number of slices that make up the
			// disc.
			// Think of slices like the slices in a piazza.
			// The more slices you have, the smoother the outer edge of the disc
			// will be.
			// Finally the fourth parameter (32) is the number of rings that
			// make up the disc.
		...
		case 3: // Sphere
			...
			// the radius is the distance from the center of the object to the
			// outside
		...
		case 4: // Cone
			...
			// make the radius at one end zero. This will create a point at one
			// end.
			// A cone with a bottom radius of 0.5 and a height of 2.0
			glu.gluCylinder(quadric, 1.0f, 0.0f, 3.0f, 32, 32);
			break;
		case 5: // gluPartialDisc
			// The object we create using this command will look exactly like
			// the
			...
			// We'll increase the sweep angle, which causes the disc to be
			// slowly
			// drawn to the screen in a clockwise direction.
			// Once our sweep hits 360 degrees we start to increase the start
			// angle.
