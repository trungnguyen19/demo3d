...
public class JOGL2Nehe19Fireworks implements GLEventListener, KeyListener {
	private static String TITLE = "NeHe Lesson #19a: Fireworks"; // window's
																	// title
	...
	class Particle {
		...
		{ 1.0f, 0.5f, 0.5f }, { 1.0f, 0.75f, 0.5f }, { 1.0f, 1.0f, 0.5f },
				{ 0.75f, 1.0f, 0.5f }, { 0.5f, 1.0f, 0.5f },
				{ 0.5f, 1.0f, 0.75f }, { 0.5f, 1.0f, 1.0f },
				{ 0.5f, 0.75f, 1.0f }, { 0.5f, 0.5f, 1.0f },
				{ 0.75f, 0.5f, 1.0f }, { 1.0f, 0.5f, 1.0f },
				{ 1.0f, 0.5f, 0.75f } };
