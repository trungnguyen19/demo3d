...
/**
 * NeHe Lesson #19: Particle Engine Using Triangle Strips Change the "squarish"
 * explosion to a "round" explosion
 */
public class JOGL2Nehe19Particles implements GLEventListener, KeyListener {
	...
	public void init(GLAutoDrawable drawable) {
		...
		gl.glHint(GL_POINT_SMOOTH_HINT, GL_NICEST); // really nice point
													// smoothing
	...
	public void display(GLAutoDrawable drawable) {
		...
		for (int i = 0; i < MAX_PARTICLES; i++) {
			if (particles[i].active) {
				...
				gl.glBegin(GL_TRIANGLE_STRIP); // build quad from a triangle
												// strip
	...
	class Particle {
		...
		public void burst() {
			...
			// Multiplied by 10 to create a spectacular explosion when the
		...
		public void regenerate() {
			...
			// Generate a random speed and direction in polar coordinate, then
			// resolve
			// them into x and y. Increase the Random speed to between -30 to
			// +30
